...
class FixedModuleLoader {
    ...
    async loadSearchModule() {
        ...
        const modulePath = `/static/js/modules/search-module.js?t=${timestamp}`;
    ...
    async loadDirectoryModule() {
        ...
        // 动态导入三级目录模块 - 添加时间戳防止缓存
        const timestamp = new Date().getTime();
        const modulePath = `/static/js/modules/directory-three-level.js?t=${timestamp}`;
        console.log(`导入模块: ${modulePath}`);
        ...
        try {
            ...
            this.modules.directory = module.default || module;
            ...
            if (container && this.modules.directory.render) {
    ...
    async loadContentModule() {
        ...
        // 动态导入内容模块 - 添加时间戳防止缓存
        const timestamp = new Date().getTime();
        const modulePath = `/static/js/modules/content-core.js?t=${timestamp}`;
        console.log(`导入模块: ${modulePath}`);
